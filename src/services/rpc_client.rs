...
impl RpcClient {
    ...
    pub fn new_base_sepolia() -> Self {
        let endpoints = vec![
            ...
            RpcEndpoint {
                name: "Alchemy Base Sepolia".to_string(),
                url: "https://base-sepolia.g.alchemy.com/v2/demo".to_string(),
                priority: 2,
                is_active: true,
                last_success: None,
                failure_count: 0,
            ...
            RpcEndpoint {
                name: "Infura Base Sepolia".to_string(),
                url: "https://base-sepolia.infura.io/v3/demo".to_string(),
                priority: 3,
                is_active: true,
                last_success: None,
                failure_count: 0,
            ...
            RpcEndpoint {
                name: "QuickNode Base Sepolia".to_string(),
                url: "https://base-sepolia.quiknode.pro/demo".to_string(),
                priority: 4,
                is_active: true,
                last_success: None,
                failure_count: 0,
