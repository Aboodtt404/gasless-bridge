...
import { idlFactory } from './gasless-bridge.did.js';
export { idlFactory } from './gasless-bridge.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GASLESS_BRIDGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gasless-bridge.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gasless-bridge canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gasless-bridge.did.js")._SERVICE>}
 */
export const gasless_bridge = createActor(canisterId);
